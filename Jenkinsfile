...
//             }
            steps {
            	script {
					...
					sh 'dotnet nuget push cms-transforms-c-sharp/CmsTransformLibrary/CmsTransformLibrary.${versionPrefix}.nupkg -ss "https://monetate.jfrog.io/artifactory/api/nuget/v3/dotnet-local" -sk ${key}'
					sh "cd ../.."
                }
            }
        }
